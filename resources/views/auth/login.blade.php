<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="form-login">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            class="ml-4 font-semibold text-black text-black hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">{{ __('Register') }}</a>
            @endif
        ...
        @if (Route::has('password.request'))
            <a class="underline text-sm text-black hover:text-white rounded-md"
