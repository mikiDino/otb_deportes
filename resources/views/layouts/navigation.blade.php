...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.addEventListener("mousemove", function(event) {
            const navigationMenu = document.querySelector(".bg-white");

            // Altura del área superior (últimos 80 píxeles)
            const topAreaHeight = 80;

            // Altura del cursor desde la parte superior de la ventana
            const cursorDistanceFromTop = event.clientY;

            // Mostrar el menú si el cursor está en los últimos 80px del extremo superior
            if (cursorDistanceFromTop <= topAreaHeight) {
